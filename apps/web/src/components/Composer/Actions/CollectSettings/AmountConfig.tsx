        ...
        <div className="pt-4">
          <div className="flex space-x-2 text-sm">
            ...
            <div>
              ...
              <select
                className="focus:border-brand-500 focus:ring-brand-400 bg-card w-full rounded-xl border border-gray-300 outline-none disabled:bg-gray-500 disabled:bg-opacity-20 disabled:opacity-60 dark:border-gray-700 dark:bg-gray-800"
