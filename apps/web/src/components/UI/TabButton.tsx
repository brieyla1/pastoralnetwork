  ...
  return (
    <button
      ...
      className={clsx(
        ...
        'hover:bg-brand-100 flex items-center space-x-2 rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-opacity-100 dark:hover:bg-opacity-20 sm:px-5 sm:py-3'
      )}
      aria-label={name}
    >
      {icon}
